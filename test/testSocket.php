...
function test($i, $host = '127.0.0.1', $port = '7002')
{
    ...
    if (!$fp) {
        ...
        $body = '{"seq":"xxxxxxxxxxxxxx","host":"smtpdm.aliyun.com","port":"25","user":"sender@smtp.masterlab.vip","password":"MasterLab123Pwd","from":"sender@smtp.masterlab.vip","to":["121642038@qq.com","weichaoduo@163.com"],"cc":["weichaoduo@qq.com","79720699@qq.com"],"subject":"Hello","body":"hello world","attach":"D:/timg.jpg"}';
